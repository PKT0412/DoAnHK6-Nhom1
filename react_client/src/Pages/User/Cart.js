...
import { Button, Col, Form, FormControl, FormGroup, Row, Table, Toast } from "react-bootstrap";
import "./css/Cart.css";
...
const Cart = () => {
  ...
  const handleDelete = (id) => {
    const shouldDelete = window.confirm("Bạn có chắc chắn muốn xóa sản phẩm yêu thích này?");
    if (shouldDelete) {
      axiosClient
    ...
    <>
      ...
      <div className="page-body">
        <Row className="row-body">
          <Col sm={8}>
            <Form style={{ backgroundColor: "white", padding: "10px", marginTop: ".5cm", marginLeft: "5cm", borderRadius: "20px", marginBottom: ".5cm" }}>
