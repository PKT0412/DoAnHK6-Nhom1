...
INSERT INTO Brands(Name, Image, Status) VALUES (N'SamSung', N'SamSung.png', 1);
...
INSERT INTO Brands(Name, Image, Status) VALUES (N'Vivo', N'Vivo.png', 1);
...
VALUES (N'Xiaomi Redmi 12', N'IPS LCD6.79"Full HD+', N'Android 13', N'Chính 50 MP & Phụ 8 MP, 2 MP', N'8 MP', N'MediaTek Helio G88', N'4 GB', 
...
INSERT INTO PhoneModels(Name, Screen, OperatingSystem, RearCamera, FrontCamera, Chip, RAM, SIM, BatteryAndCharger, PhoneModelType, OldPrice, PromotionalPrice, Image, StarAverage, Status, BrandId) 
VALUES (N'Xiaomi 13T 5G', N'AMOLED6.67"1.5K', N'Android 13', N'Chính 50 MP & Phụ 50 MP, 12 MP', N'20 MP', N'MediaTek Dimensity 8200-Ultra', N'8 GB', 
...
INSERT INTO Phones(Name, Color, Storage, Image, Price, Stock, Status, PhoneModelId)
VALUES (N'Xiaomi Redmi 12 64GB', N'Bạc', N'64GB', N'xiaomi-redmi-12-den.jpg', 4290000, 10, 1, 1);
INSERT INTO Phones(Name, Color, Storage, Image, Price, Stock, Status, PhoneModelId)
